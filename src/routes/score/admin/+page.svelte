...
<style>
	.admin-page { position: relative; min-height: 100vh; padding: clamp(26px, 5vw, 72px); display: grid; place-items: center; background: #fff; }.admin-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: clamp(12px, 2vw, 28px); width: min(1420px, 100%); }.admin-card { position: relative; min-height: clamp(290px, 43vw, 520px); padding: 26px; border-radius: 30px; display: grid; place-items: center; color: #fff; box-shadow: 0 18px 42px rgb(24 31 45 / 14%); }.coral { background: #f5a293; }.sky { background: #56ccf2; }.violet { background: #9f87dd; }.green { background: #6fcf97; }input { position: absolute; top: clamp(84px, 9vw, 118px); width: calc(100% - 48px); border: 0; border-bottom: 2px solid rgb(255 255 255 / 52%); border-radius: 0; background: transparent; color: #fff; font: 800 clamp(17px, 1.7vw, 25px) var(--font-sans); letter-spacing: -.04em; text-align: center; outline: none; }input:focus { border-bottom-color: #fff; }strong { font: 800 clamp(88px, 12vw, 184px) / 1 var(--font-sans); letter-spacing: -.1em; font-variant-numeric: tabular-nums; transform: translateX(-10px); }.arrow { position: absolute; left: 50%; width: 58px; height: 58px; border: 0; border-radius: 50%; background: rgb(255 255 255 / 22%); color: #fff; cursor: pointer; font: 700 36px / 1 var(--font-sans); transform: translateX(-50%); }.arrow:hover { background: rgb(255 255 255 / 36%); }.arrow:not(:disabled):active { transform: translateX(-50%) scale(.97); }.arrow:disabled, .reset:disabled { cursor: wait; opacity: .55; }.up { top: 24px; }.down { bottom: 24px; }.reset { position: absolute; right: clamp(26px, 5vw, 72px); bottom: 20px; border: 0; border-radius: 999px; padding: 10px 15px; background: #f2f3f5; color: #566170; cursor: pointer; font: 700 13px var(--font-sans); }.message { position: absolute; bottom: 20px; left: clamp(26px, 5vw, 72px); margin: 0; color: #b24b4b; font-size: 13px; }@media (max-width: 760px) { .admin-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }.admin-card { min-height: 250px; border-radius: 22px; }input { top: 78px; }.arrow { width: 46px; height: 46px; font-size: 29px; }.up { top: 16px; }.down { bottom: 16px; } }@media (max-width: 420px) { .admin-grid { gap: 10px; }.admin-card { min-height: 205px; padding: 18px; }input { top: 66px; font-size: 15px; } }
</style>
